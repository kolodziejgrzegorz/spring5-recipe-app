...
public class IngredientServiceImpl implements IngredientService {
    ...
    public IngredientCommand saveIngredientCommand(IngredientCommand command) {
        ...
        if(!recipeOptional.isPresent()){
            log.error("Not found recipe id:" + command.getRecipeId());
    ...
    public void deleteByRecipeIdAndIngredientId(Long recipeId, Long ingredientId) {
        ...
        if(recipeOptional.isPresent()) {
            log.error("Found recipe with id" + recipeId);
            ...
            if(ingredientToDeleteOptional.isPresent()) {
                Ingredient ingredient = ingredientToDeleteOptional.get();
                ingredient.setRecipe(null);
                recipe.getIngredients().remove(ingredientToDeleteOptional.get());
                log.debug("Remove ingredient with id: " + ingredient.getId() + " from recipe with id: " + recipeId);
